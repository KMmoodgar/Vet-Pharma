    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        docUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                loadingBar.setTitle("Update Doctor");
                loadingBar.setMessage("Please wait...while we update the details");
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        loadingBar.setTitle("Delete Doctor");
                        loadingBar.setMessage("Please wait...while we delete the doctor");
                        loadingBar.setCanceledOnTouchOutside(false);
                        loadingBar.show();
